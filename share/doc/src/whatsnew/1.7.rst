...
This will be the last release of the CouchDB 1.x line. There will be no more
feature-, bugfix-, or security releases.

The branch is now managed by Ondrej Novak.

Bug Fix
-------

- Fix config whitelist bypass
